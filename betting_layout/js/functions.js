    ...
    $.getJSON("db_items.json", function(json) {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        var row_string = '<div class="col-md-12 tabs-first">{{title}}' +
          ...
          '<div class="col-md-6 col-sm-6 col-xs-6 uderline"><strong>{{legue}}</strong></div>' +
          '<div class="col-md-6 col-sm-6 col-xs-6 uderline"><span>Market</span><span>1</span><span>2</span><span><i class="fa fa-star"></i></span></div>' +
